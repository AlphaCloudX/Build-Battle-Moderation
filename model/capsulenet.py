...
def CapsNet(input_shape, n_class, num_routing):
    ...
    #
    # print(routingWeights.shape)
    # print(routingWeights)
    ...
    eval_model = models.Model(x, [out_caps, decoder(masked), digitcaps])
...
def load_mnist2():
    ...
    (x_train, y_train) = load_data(r'C:\Users\Michael\Desktop\Mnist_test\data\mnist_train_data.h5')
    (x_test, y_test) = load_data(r'C:\Users\Michael\Desktop\Mnist_test\data\mnist_validation_data.h5')
